...
class Turma extends \Application\Entity\Turma implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Turma' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Turma' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\Turma' . "\0" . 'instituicao', '' . "\0" . 'Application\\Entity\\Turma' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Turma' . "\0" . 'dataCriacao', '' . "\0" . 'Application\\Entity\\Turma' . "\0" . 'ativo');
        }
